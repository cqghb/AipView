		...
		data() {
			return {
				fieldList:[
					...
					{ name: "code", fieldName: "货品编码", type: "text", fieldValue: "" },
					{ name: "name", fieldName: "货品名称", type: "text", fieldValue: "" },
					{ name: "typeName", fieldName: "货品分类", type: "text", fieldValue: "" },
					{ name: "brandName", fieldName: "品牌", type: "text", fieldValue: "", transformation: BusinessConstant.CODE_TYPE.DATA_OPERATE_SUBGROUP },
					{ name: "briefIntroduction", fieldName: "货品简介", type: "text", fieldValue: "" },
					{ name: "remark", fieldName: "货品详情", type: "text", fieldValue: "" },
					{ name: "detail", fieldName: "备注", type: "text", fieldValue: "" },
